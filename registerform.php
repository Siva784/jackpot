...
<html lang="en">
<head>
	<title>JACKPOT Register</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="images/dice.gif"/>
<!--===============================================================================================-->
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				...
				<form class="login100-form validate-form flex-sb flex-w" method="POST" action="rfsubmit.php" onsubmit="return validate()">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "retype-Password is required">
                        ...
                        <span class="focus-input100"></span>
                        <input type="checkbox" onclick="Toggle1()"><p>Show Password</p>
					...
					<div class="p-t-31 p-b-9">
						<span class="txt1">
							Security pin <p>for password recovery purpose</p>
						</span>
					</div>
					<div class="wrap-input100 validate-input" data-validate = "security pin is required">
                        <input class="input100" type="text" name="spin" id="spin">
    ...
    <script>
        function validate()
        {
            ...
            if(lspin<6 || lspin>6)
            {
                document.getElementById('err4').innerHTML="security pin must be a 6 digit code";
                return false;
            }
            return true;
        }
