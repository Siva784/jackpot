...
<body>
		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				<div>
					...
					<form class="login100-form validate-form flex-sb flex-w" method="POST" action="loginsubmit.php" >
					...
					<div class="wrap-input100 validate-input" data-validate = "Username is required">
						<input class="input100" type="text" name="lusername" id="lusername">
					...
					<div class="w-full text-center p-t-55">
						...
						<a href="registerform.php" class="txt2 bo1">
							Sign Up now
						</a>
					</div>
				</form>
	...
	<script>
		 function Toggle2()
        {
            var temp2 = document.getElementById("lpassword"); 
