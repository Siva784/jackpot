      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Pending Deposit</li>
          </ol>
        </section>
          ...
          <div class="row">
            <div class="col-sm-12">
              <?php
                  include('../connection.php');
                  $trans=0;
                $query="SELECT  `username`, `balance`, `amount`, `transactionid`, `transstatus` FROM `deposit`  where transstatus=$trans";
            ...
            echo "<td class='danger'>Transaction status</td>";
            echo "</tr>";
            ...
            echo "<td class='danger'><form method='POST' action='submitpendingdeposit.php'>
            ...
            <input type='text' value='$transid' name='transid'  style='display:none'>
            <input type='submit'>
            </form></td>";
